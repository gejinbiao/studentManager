...
public class SimpleTemplateEngine extends GunsTemplateEngine {
    ...
    protected void generateEntity() {
        String modelPath = ToolUtil.format(super.getContextConfig().getProjectPath() + super.getDoConfig().getModelPathTemplate(),
                ToolUtil.firstLetterToUpper(super.getContextConfig().getBizEnName()));
        generateFile("gunsTemplate/Entity.java.btl", modelPath);
