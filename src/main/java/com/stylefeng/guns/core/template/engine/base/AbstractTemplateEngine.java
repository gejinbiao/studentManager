...
public class AbstractTemplateEngine {
    ...
    protected EntityConfig doConfig;                    //do配置
    ...
    public void initConfig() {
        ...
        if(this.doConfig == null){
            this.doConfig = new EntityConfig();
        }
        ...
        this.doConfig.setContextConfig(this.contextConfig);
        this.doConfig.init();
    }
    ...
    public EntityConfig getDoConfig() {
        return doConfig;
    }

    public void setDoConfig(EntityConfig doConfig) {
