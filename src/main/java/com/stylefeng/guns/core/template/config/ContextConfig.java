...
public class ContextConfig {
    ...
    private String bizChName;   //业务名称(中文名称)
    private String bizEnName;   //业务英文名称(表明)
    private String bizEnBigName;//业务英文名称(大写)
    private String moduleName = "system";  //模块名称
    private List<CodeModel> codeModels; //数据库表结构
    private String lowerName; //首字母小写类名
    ...
    private Boolean modelSwitch = true;         //model
