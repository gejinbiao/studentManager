...
public class UserMgrController extends BaseController {
    ...
    @ResponseBody
    public Object list2(User user, PageReq pageReq) {
        List<User> users = userService.selectUsers(user, pageReq);
        Object list = new UserWarpper(users, "list").warp2();
        return packForBT((List<User>)list);
    }
