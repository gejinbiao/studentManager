...
(function () {
    var BSTable = function (bstableId, url, columns) {
        ...
        this.showColumnsFlag = true;//是否显示所有列按钮
    };
    ...
    BSTable.prototype = {
        ...
        init: function () {
            ...
            this.btInstance =
                $('#' + tableId).bootstrapTable({
                    ...
                    showColumns: this.showColumnsFlag,     		//是否显示所有的列
                    showRefresh: this.showRefreshFlag,     		//是否显示刷新按钮
        ...
        setShowRefresh: function (data) {
            this.showRefreshFlag = data;
        },
